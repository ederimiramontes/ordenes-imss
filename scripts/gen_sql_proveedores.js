/**
 * gen_sql_proveedores.js
 * Genera SQL para insertar los 99 proveedores via Management API
 */
const PROVEEDORES = [
  ...
  {consecutivo:2,razon_social:"JOSE AMEZCUA PEREZ",rfc:"AEPJ440830482",domicilio:"",ret_isr:false},
  ...
  {consecutivo:4,razon_social:"RAMON AMEZCUA PEREZ",rfc:"AEPR591003GM8",domicilio:"SERAFIN,3,LOS PUESTOS, CP 45638 TLAQUEPAQUE JALISCO MEXICO.",ret_isr:false},
  ...
  {consecutivo:6,razon_social:"ASESORIA Y PROVEEDORA DE EQUIPOS PARA LABORATORIO S.A. DE C.V.",rfc:"APE950801FJ4",domicilio:"AV MÉXICO 2522 FRACC. LADRON DE GUEVARA GUADALAJARA JALISCO MÉXICO 44600",ret_isr:false},
  ...
  {consecutivo:13,razon_social:"CARLOS ALBERTO CASTANOS VAZQUEZ",rfc:"CAVC711105DHA",domicilio:"OAXACA 801-2 COL. PUEBLO NUEVO MEXICALI BAJA CALIFORNIA MEXICO 21120",ret_isr:false},
  {consecutivo:14,razon_social:"CPS COMERCIALIZADORA DE PRODUCTOS Y PROVEEDORA DE SERVICIOS DE LIMPIEZA SA DE CV",rfc:"CCP1303022Y3",domicilio:"AV. TIBURON 508 EDIFICIO 2DO PISO MZ 53 LT23 FRACCIONAMIENTO COSTA DE ORO BOCA DEL RIO VERACRUZ MÉXICO 94299",ret_isr:false},
  ...
  {consecutivo:17,razon_social:"CTG Ingenieria y Construccion, S.A. de C.V.",rfc:"CIC170531DI1",domicilio:"Puerto México 47 Col. San Jeronimo Chicahualco Metepec México 22210",ret_isr:false},
  ...
  {consecutivo:24,razon_social:"JESUS ABRAHAM DIMAS MARTINEZ",rfc:"DIMJ9201167GA",domicilio:"CALLE PERU 702 AVIACION SAN LUIS RIO COLORADO SONORA MÉXICO 83470",ret_isr:false},
  ...
  {consecutivo:28,razon_social:"ESI and SUPPLY S R.L DE C.V.",rfc:"EAS2104128M8",domicilio:"ARQUITECTOS 2201 UNIVERSITARIO MEXICALI BAJA CALIFORNIA MEXICO 21180",ret_isr:false},
  ...
  {consecutivo:31,razon_social:"ELEVADORES OTIS S DE RL DE CV Suc",rfc:"EOT631205877",domicilio:"CALLE 10 145 2DO PISO COL. SAN PEDRO DE LOS PINOS CIUDAD DE MÉXICO MÉXICO 1180",ret_isr:false},
  ...
  {consecutivo:35,razon_social:"ALEJANDRO GARCIA LUNA",rfc:"GALA620730PI2",domicilio:"AV.RIO BLANCO 3248 COL. GONZALEZ ORTEGA NORTE MEXICALI BAJA CALIFORNIA MÉXICO 21396",ret_isr:false},
  ...
  {consecutivo:40,razon_social:"Ana Claudia Gonzalez Ortiz",rfc:"GOOA760420NM3",domicilio:"C. 20 de Noviembre No. 2039 Col. Nueva Madero Monterrey Nuevo Leon C.P. 64560",ret_isr:true},
  {consecutivo:41,razon_social:"GE Sistemas Medicos de Mexico S.A. de C.V.",rfc:"GSM920409JL6",domicilio:"C. Antonio Dovali Jaime No. 70 Torre B Piso 4 Col. Santa Fe Alcaldia Alvaro Obregon Cd de Mexico C.P. 01210",ret_isr:true},
  {consecutivo:42,razon_social:"Raul Hernandez Carrillo",rfc:"HECR5011269N2",domicilio:"C. Begonia No. 29 Fortin de las Flores Col. La Mesa Tijuana Baja California Mexico C.P. 22114",ret_isr:true},
  {consecutivo:43,razon_social:"PORTACOOL MEXICALI ANTONIO HURTADO NUNEZ",rfc:"HUNA921019815",domicilio:"CUAUHTEMOC 8/1. CUAUHTEMOC SUR CP.21200 MEXICALI BAJA CALIFORNIA",ret_isr:true},
  ...
  {consecutivo:53,razon_social:"LOPEZ COSSIO MARIA BEATRIZ",rfc:"LOCB840110NX0",domicilio:"Av. Argentina 204 Cuauhtemoc Norte Mexicali Baja California Mexico 21200",ret_isr:true},
  {consecutivo:54,razon_social:"MARIA BEATRIZ LOPEZ COSSIO",rfc:"LOCB8440110NX0",domicilio:"AV. ARGENTINA 204 CUAUHTEMOC NORTE MEXICALI BAJA CALIFORNIA MEXICO 21200",ret_isr:true},
  {consecutivo:55,razon_social:"GILBERTO LOPEZ DIAZ",rfc:"LODG530128N56",domicilio:"ARGENTINA No498 No INT 2 COL. CUAUHTEMOC NORTE MEXICALI B.C. C.P. 21200",ret_isr:true},
  ...
  {consecutivo:57,razon_social:"SALVADOR LOPEZ LOPEZ",rfc:"LOLS460515N31",domicilio:"AV. LAGO TANGANICA No.1348 COL. JARDINES DEL LAGO C.P. 21330 MEXICALI BAJA CALIFORNIA MÉXICO",ret_isr:true},
  ...
  {consecutivo:59,razon_social:"GUILLERMO ANTONIO LONGORIA ROMERO",rfc:"LORG711117T49",domicilio:"BLVD. DIAZ ORDAZ 1111 110 FRACCIONAMIENTO LOS ARBOLES C.P. 22117 TIJUANA BAJA CALIFORNIA MÉXICO",ret_isr:true},
  ...
  {consecutivo:66,razon_social:"Jose Julio Mendoza Santiago",rfc:"MESJ6312044T7",domicilio:"Circuito Arcos No. 19131 Int A Col. Otay Galerias Tijuana Baja California Mexico C.P. 22436",ret_isr:false},
  ...
  {consecutivo:69,razon_social:"Maria Angelica Moreno Araujo",rfc:"MOAA801227W4",domicilio:"C. ixtlacihuatl No. 12220 Col Camino Verde Tijuana Baja California Mexico C.P 22680",ret_isr:false},
  {consecutivo:70,razon_social:"CLAUDIA BELEN NUNEZ GARCIA",rfc:"NUGC791205GT5",domicilio:"",ret_isr:false},
  {consecutivo:71,razon_social:"FEDERICO NUNO GUTIERREZ",rfc:"NUGF681118N33",domicilio:"CALLE CUARTA 1183 INT D COL GONZALEZ ORTEGA CP. 21397 MEXICALI BC",ret_isr:false},
  ...
  {consecutivo:79,razon_social:"Pest Control Baja S.A. de C.V.",rfc:"PCB900924348",domicilio:"C. Aldama No. 254 Col. Independencia Ensenada Baja California Mexico C.P. 22840",ret_isr:false},
  {consecutivo:80,razon_social:"Juan de Dios Pena Bayardo",rfc:"PEBJ9703085X2",domicilio:"Av. Paseo Guaycura No. 20535 Ampliacion Guaycura Tijuana Baja California Mexico C.P. 22214",ret_isr:false},
  {consecutivo:81,razon_social:"PRO LAB RX S.A. DE C.V.",rfc:"PLR020930F82",domicilio:"CALLE EJIDO LA CANDELARIA No.84 COL. AMPLIACION SAN FRANCISCO CULHUACAN DELEGACION COYOACAN MEXICO D.F. C.P. 04420",ret_isr:false},
  ...
  {consecutivo:86,razon_social:"QUIMICA MEXICANA INDUSTRIAL",rfc:"QMI640701EPA",domicilio:"CARRETERA CUAUTITLAN TEOLOYUCAN NO. 4 FRACCIONAMIENTO INDUSTRIAL XHALA MÉXICO C.P. 54750",ret_isr:false},
  ...
  {consecutivo:89,razon_social:"DANIEL REMIGIO SALCIDO",rfc:"RESD870619A64",domicilio:"RIO PRESIDIO No. 2021 CONSTITUCION MEXICALI BAJA CALIFORNIA MÉXICO C.P. 21250",ret_isr:false},
  ...
  {consecutivo:93,razon_social:"SERVICIOS MEDICOS Y TECNICOS SA DE CV",rfc:"SMT010905FL0",domicilio:"CALLE FERNANDO AMILPA No. 48 INT: 1ER PISO COL. CTM EL RISCO C.P. 07090 GUSTAVO A MADERO CIUDAD DE MEXICO MEXICO",ret_isr:false},
  {consecutivo:94,razon_social:"Ma. Lidia Solorzano Trinidad",rfc:"SOTL600804848",domicilio:"C. Josefa Ortiz de Dominguez No. 7470 Col. La Cima Tijuana Baja California Mexico C.P. 22616",ret_isr:false},
  {consecutivo:95,razon_social:"SERVICIO Y SOPORTE BIOMEDICO SA DE CV",rfc:"SSB100323G33",domicilio:"Monte Elbruz No. ext.132 Int. Piso 6 604 Col. Lomas de Chapultepec Deleg. Miguel Hidalgo C. P. 11000 CDMX Mexico",ret_isr:false},
  ...
  {consecutivo:97,razon_social:"VICTOR HUGO URENA BELTRAN",rfc:"UEBV6702174F1",domicilio:"AV. DE LOS MAGISTRADOS No. EXT. 399 COL. FRACC. MISION SANTO DOMINGO C.P. 21298 MEXICALI BAJA CALIFORNIA MÉXICO",ret_isr:false},
  ...
  {consecutivo:99,razon_social:"VIASIS SERVICIO S.A. DE C.V.",rfc:"VSE1505131U0",domicilio:"LUIS SPOTA NO. 5 COL. SAN SIMON TICUMAC ALCALDIA BENITO JUAREZ C.P. 03660 CDMX",ret_isr:false}
];

const vals = PROVEEDORES.map(p => {
  const r = p.razon_social.replace(/'/g, "''");
  const d = (p.domicilio||'').replace(/'/g, "''");
  const rfc = (p.rfc||'').replace(/'/g, "''");
  return `(${p.consecutivo}, '${r}', '${rfc}', '${d}', ${p.ret_isr}, 0.08, true)`;
}).join(',\n');

const sql = `INSERT INTO proveedores_catalogo (consecutivo,razon_social,rfc,domicilio,ret_isr,iva_rate,activo) VALUES\n${vals}\nON CONFLICT DO NOTHING;`;
